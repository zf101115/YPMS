...
public class InstitutionActiveActivity extends ToolBarActivity {
    ...
    @BindView(R.id.ll_active_header)
    ...
    public static void startActivity(Context mContext) {
        Intent intent = new Intent(mContext, InstitutionActiveActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llActiveHeader.setVisibility(View.VISIBLE);
        initData();
    }
